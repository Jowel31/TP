...
/**
   ...
   @author <A HREF="mailto:francois.major@umontreal.ca">Fran√ßois Major</A>
...
/**
     TP1 - IFT1025
     noms et pr√©noms des co√©quipier(s)
...
public class Savane implements TP1Stats {
	...
	int annee;
	    ...
	    savane.reproduire(); // ----- LA SAVANE PROCR√âE -----
	    // debugging-output
	...
	String indice = "Ëme";
	if( annee == 1 ) indice = "iËre";
	
        if( show ) {
	    print( "///////////////////////////// ‡ la fin de la " + annee + indice + " annÈe, nous observons :" );
	    ...
	    print( nombreLionsMatures + " lions matures ;" );
            ...
            print( nombreBebesLions + " bÈbÈs lions ;" );
	    ...
	    print( nombreAntilopesMatures + " antilopes matures ;" );
            ...
            print( nombreBebesAntilopes + " bÈbÈs antilopes ; et" );

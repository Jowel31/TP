...
public class SavaneTest implements TP1Stats {
	...
	public double[] stats( int annee, boolean show ) {
		...
		String indice = "�me";
		if( annee == 1 ) indice = "i�re";

		if( show ) {
			print( "///////////////////////////// � la fin de la " + annee + indice + " ann�e, nous observons :" );
			...
			print( nombreBebesLions + " b�b�s lions ;" );
			...
			print( nombreBebesAntilopes + " b�b�s antilopes ; et" );
